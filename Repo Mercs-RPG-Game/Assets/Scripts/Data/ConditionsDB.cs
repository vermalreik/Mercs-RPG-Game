...
public class ConditionsDB
{
    ...
    {
        foreach (var kvp in Conditions) //k ey value pair
        {
        ...
        },
        {
            ...
            new Condition()
            {
                ...
                OnBeforeMove = (Pokemon pokemon) =>
                {
                    ...
                    return true; // able to perform the move
                }
            }
        },
        {
...
{
    none, psn, brn, slp, par, frz, // poison, burn, sleep, paralisis, freeze - Status Condition
